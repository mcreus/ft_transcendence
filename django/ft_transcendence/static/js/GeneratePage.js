...
function navigateTo(view) {
	...
	if (view == 'salon' || view == 'local' || view == 'profile' || view == 'fast_game' || view == 'historic' || view.search("other_profile/") != -1 || view.search("tournament_online/") != -1)
	{
		...
		main.onanimationend = () => {
			...
			main.onanimationend = () => {
				...
				if (view == 'fast_game')
					init('online');
				else if (view.search("tournament_online/") != -1)
				{
					alerte = false;
					init('online_tournament');
				}
			}
		};
	}
	...
	if (view == 'fast_game' || view == 'salon' || view == '')
	{
